			<form id="login_form1" class="form-signin" method="post">
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to Online Tutoring System", { header: 'Access Granted' });
									var delay = 1000;
			...
			New to Online Tuition?
			<hr>
				<h3 class="form-signin-heading"><i class="icon-edit"></i> Sign up</h3>
				<button data-placement="top" title="Sign In as Student" id="signin_student" id="btn_student" name="login" class="btn btn-info" type="submit">I`m a Student</button>
				<div class="pull-right">
					<button data-placement="top" title="Sign In as Teacher" id="signin_teacher" name="login" class="btn btn-info" type="submit">I`m a Teacher</button>
				</div>
			</div>
														<script type="text/javascript">
														$(document).ready(function(){
